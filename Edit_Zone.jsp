...
<html lang="en">
    ...
    <body >
        ...
        <section class="ftco-section">
            ...
            <form action="saveZoneUpdate.jsp" method="POST" >
...
try
                    ...
                    String sql="SELECT `Zone_Name`, `Supervisor`, `Contact` FROM `zone` WHERE `Zone_Id`='"+in+"'";
                ...
                <table border="1" align="center">
                    <tbody>  
                        <tr>
                            ...
                            <td><input type="hidden" name="idff" value="<%= in %>" readonly=""/></td>
                        </tr>
                        <tr>
                            <td>ZONE</td>
                            <td><input type="text" name="zoneName" value="<%= rs.getString(1)%>" readonly=""/></td>
                        </tr> 
                        <tr>
                            <td>PRESIDENT</td>
                            <td><input type="text" name="super" value="<%= rs.getString(2).toUpperCase() %>" /></td>
                        </tr>
                        <tr>
                            <td>CONTACT</td>
                            <td><input type="text" name="contact" value="<%= rs.getString(3).toUpperCase() %>" /></td>
                        </tr>
                        <%                              
            }
            ...
            <table border="1" align="center">
                ...
                <tbody>
                    ...
                    <tr> <td><%= rs.getInt(1) %></td>
                        ...
                        <td><a href="saveZoneUpdate.jsp?id=<%=rs.getInt(1)%>"/> Modifier </td>
