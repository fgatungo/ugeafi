...
<html lang="en">
    ...
    <body >
        ...
        <section class="ftco-section">
            ...
            <!-- END nav -->
            <form action="Rapport_Contribution.jsp"method="GET">
                <table border="0" align="center" style="margin-top: 20px;">
                    <thead>
                        <tr>
                            <th colspan="2">FAITEZ LE CHOIX DE LA ZONE POUR VOUR LES CONTRIBUTIONS</th>
            ...
            String sql="SELECT contribution.Dates,contribution.Ben_Id,contribution.Contribution,contribution.Mois_de, create_beneficiaire.Name,zone.Zone_Name,create_beneficiaire.Lname,avec.Names from contribution inner JOIN create_beneficiaire on contribution.Ben_Id=create_beneficiaire.Id INNER JOIN zone on zone.Zone_Id=create_beneficiaire.Zone_Id inner JOIN avec on avec.Id=create_beneficiaire.Avec_Id WHERE contribution.Dates BETWEEN '"+from+"' and '"+too+"' and zone.Zone_Name='"+zona+"'";
             ResultSet rs=st.executeQuery(sql);
                %>
                <thead>
                    <tr>
            ...
            <table border="1" align="center" style="margin-top: 20px;">
             ...
             Statement st=conn.createStatement();
            // String sql="select *from create_beneficiaire where Zone='"+zona+"'";
            String sql="SELECT sum(contribution.Contribution),contribution.Mois_de, create_beneficiaire.Name,zone.Zone_Name,create_beneficiaire.Lname,avec.Names from contribution inner JOIN create_beneficiaire on contribution.Ben_Id=create_beneficiaire.Id INNER JOIN zone on zone.Zone_Id=create_beneficiaire.Zone_Id inner JOIN avec on avec.Id=create_beneficiaire.Avec_Id WHERE contribution.Dates BETWEEN '"+from1+"' and '"+too1+"' and zone.Zone_Name='"+zona1+"'";
             ResultSet rs=st.executeQuery(sql);
                %>
                <thead>
                    <tr>
